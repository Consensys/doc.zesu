...
Zesu is a stateless EVM block executor, written in Zig and designed to run as a <GlossaryTerm term="zkVM">zkVM</GlossaryTerm> <GlossaryTerm term="Guest program">guest
program</GlossaryTerm>.
