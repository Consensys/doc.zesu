...
name: style-review
description: >-
  Review Zesu documentation for editorial compliance (voice, terminology, formatting, content
...
- If the file is new, verify it has been added to `sidebars.js` in the correct category and
